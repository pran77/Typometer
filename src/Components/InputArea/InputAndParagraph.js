...
function InputAndParagraph() {
  ...
  const para3 = "There are a number of reasons you may need a block of text and when you do a random paragraph can be the perfect solution"
  ...
  const para5 = "If you happen to be a web designer and you need some random text to show in your layout a random paragraph can be an excellent way to do this"
