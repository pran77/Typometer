        ...
        <div className='a-wrapper'>
          ...
          <div className='a-text'>
            <b >Typometer is a typing test website. A user can check his/her typing speed based on the generated paragraph.
              In the test either user will complete the test or can submit it whenever he/she wants. On the basis of time elapsed user will get to know the result
          ...
          <div className='features'> 
           {images_data.map((item) =>(
                <Cards key={item.id} img={item.img} text={item.text} title={item.title}/>
           ))}
